...
//    public static UUID BLE_DOWNLOAD_ERROR_RESET_UUID = UUID.fromString(SampleGattAttributes.BLE_DOWNLOAD_ERROR_RESET);
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        Log.i(TAG, "data: " + byteArrayToHexString (characteristic.getValue()));
...
//    public BluetoothGattService getBleDownService() {
//        BluetoothGattService _service = mBluetoothGatt.getService(UUID_ELARA_SERIAL_UUID);
//        if (_service == null) {
//            Log.d(TAG, "BLE Download Service not found!");
//            return null;
//        }
//        return _service;
//    }
